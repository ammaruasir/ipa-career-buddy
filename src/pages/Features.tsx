...
const sections = [
  {
    ...
    body: [
      ...
      "في وضع التقييم: نتيجة كاملة تصل لـ HR، تُحدَّث في pipeline التوظيف، نموذج GPT-4.1 الكامل.",
    ],
    features: [
      "Row-Level Security يمنع HR من رؤية جلسات التدريب",
      "نموذج أرخص (gpt-4.1-mini) للتدريب لخفض التكلفة",
  ...
  },
  {
    ...
    body: [
      ...
      "موافقات PDPL صريحة قبل إرسال أي صوت/فيديو/سيرة لـ third-party AI (Google Gemini عبر Lovable Gateway). يمكن إلغاء الموافقة في أي وقت.",
