...
const sections = [
  ...
  },
  {
    ...
    color: "amber",
    body: [
      "بدلاً من شاشة فارغة، يحاورك واكب AI بـ ١٥ سؤالاً موجَّهاً: مستوى خبرتك، الوظيفة المستهدفة، آخر إنجازاتك، إلخ.",
      "لكل سؤال — إن أردت — تطلب اقتراحاً من واكب AI كنقطة بداية. تقبل، تعدّل، أو تكتب من جديد.",
      "في النهاية: مسوّدة سيرة كاملة جاهزة في المنشئ للتعديل النهائي.",
    ],
    features: [
      "ثنائية اللغة (عربي / إنجليزي / كلاهما)",
      "اقتراح واكب AI في كل سؤال (اختياري)",
  ...
  },
  {
    id: "cv-builder",
    icon: PenLine,
    title: "منشئ يدوي مع مساعدة واكب AI",
    subtitle: "تحكّم كامل، ومساعدة عند الطلب",
    color: "secondary",
    body: [
      "Stepper من ٧ خطوات: البيانات الشخصية → الملخّص → الخبرة → التعليم → المهارات → الشهادات → معاينة.",
      "في كل قسم: زر ✨ واكب AI لتحويل ما تكتبه إلى صيغة احترافية. خصوصاً في الخبرة: اكتب وصفاً حرّاً، واكب AI يحوّله إلى STAR bullets قابلة للقبول/التعديل.",
    ],
    features: [
  ...
  },
  {
    id: "question-bank",
    icon: BookOpen,
    title: "بنك أسئلة واكب — جدارات حكومية",
    ...
    body: [
      ...
      "كل سؤال: مستوى صعوبة، إجابة نموذجية، معايير STAR rubric، وحالة (draft / review / approved). محتوى جاهز للنمو مع خبراء واكب.",
    ],
    features: [
      "٨ مسارات × ٨ جدارات",
